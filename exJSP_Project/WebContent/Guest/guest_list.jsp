...
%>
		<tr onMouseOver="style.backgroundColor='#D1EEEE'" onMouseOut="style.backgroundColor=''">
          ...
          <td align="left" height="20"><font face="돋움" size="2" color="#000000"><a class="list" href="guest_view.jsp?idx=<%= rs.getInt("idx") %>"><%= rs.getString("subject") %></a></td>
          ...
          <td align="center" height="20"><font face="돋움" size="2"><%= rs.getInt("readcnt") %></font></td>
      </tr>
<%
	}
%>      
