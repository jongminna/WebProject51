...
<%@ include file="/Include/login_form.jsp" %>
   ...
   <td width="80%" valign="top">&nbsp;<br>
	...
	<form method="post" enctype="multipart/form-data" name="pds">
	  ...
	  <table border="0" >
       ...
       <tr>
		...
		<tr></tr>			<tr></tr>
          ...
          <td align=center>
			<a href="javascript:check()"><img src="Pds/img/purple_save.gif" width="56" height="18" border="0"></a>
			<a href="javascvript:reset()"><img src="Pds/img/purple_cancle.gif" width="56" height="18" border="0"></a>
		  </td>
        </tr>
      </table>
    </td>
