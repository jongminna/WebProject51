					...
					<td bgcolor="#7AAAD5">            
						...
						<table cellpadding=3 cellspacing=1 border=0 width=100%>
							<tr>
								...
								<TD BGCOLOR=WHITE>
									<input type=text name=name size=16 maxlength=20 readonly value="${user.name}">성명은 빈칸없이 입력하세요.
								</td>
							</tr>
							<tr>
								...
								<TD BGCOLOR=WHITE>
									<table cellspacing=0 cellpadding=0>
										<tr>
											<td align=absmiddle>
												<input type=text name="userid" id="userid" readonly size=12 maxlength=16 value="${user.userid}" style="width:120">
											</td>
							...
							<tr>
								...
								<td bgcolor=WHITE valign=middle>
									<input type="text" name="email" maxlength="15" value="${email1}">
									@ <input type="text" name="email2" maxlength="15" value="${email2}">
									<select name="email3">
