...
<SCRIPT>
	function send(){
		...
		user.action="/User/user_login.do";
		user.submit();
	}
</SCRIPT>
</HEAD>
<body bgcolor="#FFFFFF" text="#000000" leftmargin=0 
  topmargin=0 onLoad='document.fname.userid.focus();'>
					   ...
					   <td align=CENTER bgcolor="#eff4f8" height="92"> 
					     <table width="330" border="0" cellspacing="0" cellpadding="1">
							...
							<tr valign=bottom> 
							  ...
							  <td><input type=image src="./img/login.gif" border=0 align=absmiddle onClick="send()"></td>
							</tr>
						  </table>
						</td>
					  </tr>
