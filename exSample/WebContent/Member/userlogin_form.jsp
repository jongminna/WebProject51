...
<body bgcolor="#FFFFFF" text="#000000" leftmargin=0 
  topmargin=0 onLoad='document.login.userid.focus();'>
<br><br>
...
<TR>
  ...
  <TD>
    <table width="583" border="0" cellspacing="0" cellpadding="0" height="265">
	  <form  name="login" method=post action="userlogin_form.do"  onSubmit="return check()">
	    <tr>
		  <td height="298"> 
					   ...
					   <td align=CENTER bgcolor="#eff4f8" height="92"> 
					     <table width="330" border="0" cellspacing="0" cellpadding="1">
							...
							<tr valign=bottom> 
							  ...
							  <td nowrap>비밀번호</td>
							  <td>: 
								<input type=password name="passwd" size=14 maxlength=12 STYLE="WIDTH:155" onKeyUp=autoSubmit()>
							  </td>
							  <td><input type=image src="./Member/img/login.gif" border=0 align=absmiddle></td>
							</tr>
						  </table>
						</td>
					  </tr>
