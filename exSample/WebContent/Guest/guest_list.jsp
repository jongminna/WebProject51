  ...
  <tr>
    ...
    <table border="0" cellspacing="1" width="100%" align="center">
      ...
      <tr>
		...
		<font size="2" face="고딕"> 전체 : ${ totcount }</b>건 - ${ nowpage }/${totpage} Pages</font></td></tr>
 	   <tr bgcolor="e3e9ff">
	  ...
	  <tr onMouseOver="style.backgroundColor='#D1EEEE'" onMouseOut="style.backgroundColor=''">
        ...
        <td align="left" height="20">
        	<font face="돋움" size="2" color="#000000">
		  	<a href="guest_view?idx=${guest.idx}&page=${page}"> ${guest.subject}</a></td>
     ...
     <div align="center">
        <table width="700" border="0" cellspacing="0" cellpadding="5">
          <tr>&nbsp;</tr><tr>
			...
			<tr align=right><td colspan="5">
				<a href="guest_write?page=${page}"><img src="/Guest/img/write.gif" border="0"></a>
			</td>
			</tr>
		</table>
		<table width="600">
		<tr>
			...
			<td width="50%" align="center">
				<table>
					<form name="sguest" method="post" action="guest_list">	
					<!-- 검색어를 이용하여 글제목, 작성자, 글내용 중에 하나를 입력 받아 처리하기 위한 부분 -->
						<tr>
							...
							<td> <a href="javascript:search()"><img src="Guest/img/search2.gif" border="0"></a></td>
						</tr>
					</form>
				</table>
			</td>
