	...
	<c:forEach var="list" items="${list}">
        ...
        <font face="돋움" size="2" color="#000000">${listcount}</font></td>
			<td align="left" height="20">&nbsp;
				...
				<a class="list" href="notice_view.do?idx=${list.idx}&page=${page}">${list.subject} </a></td>
					<td align="center" height="20"><font face="돋움" size="2">
					<a class="list" >관리자</font></td>
				<td align="center" height="20"><font face="돋움" size="2"></font></td>
...
<c:if test="${empty list}">
			...
			<tr>
				<td colspan="5" align="center"><font face="돋움" size="2">등록된 자료가 없습니다</font></td>
			</tr>
</c:if>
	 ...
	 <div align="center">
        <table width="700" border="0" cellspacing="0" cellpadding="5">
          <tr>&nbsp;</tr><tr>
             <td colspan="5">        
                <div align="center"><font face="돋움" size="2">${pageSkip}</font></div>
			  </td>
			 </tr>
		</table>
				...
				<table>
					...
					<!-- 검색어를 이용하여 글제목, 작성자, 글내용 중에 하나를 입력 받아 처리하기 위한 부분 -->
						<tr>
							...
							<td> <a href="javascript:b_sCh()"><img src="/Notice/img/search2.gif" border="0"></a></td>
						</tr>
					</form>
				</table>
			</td>
			<!--<td width="25%" align="right">
			<a href="notice_write.jsp"><img src="/SampleMVC/Notice/img/write.gif" border="0"></a>
			</td> -->
		</tr>
	</table>
</body>
