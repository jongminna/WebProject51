...
<c:choose>
	<c:when test="${row==1}">
		<script>
			alert("수정되어습니다");
			location.replace("board_list?page=${page}");
		</script>
	</c:when>
	<c:when test="${row==0}">
		<script>
...
<script type="text/javascript">
 ...
 <tr>
   ...
   <td width="80%" valign="top">&nbsp;<br>
     ...
     <form name="board" method="post" action="boardreply_modify.do">
      ...
      <table border="0">
       ...
       <tr>
        ...
        <tr>
          ...
          <td>
             <a href="javascript:send()"><img src="Board/img/edit2.gif" border=0></a>&nbsp;
