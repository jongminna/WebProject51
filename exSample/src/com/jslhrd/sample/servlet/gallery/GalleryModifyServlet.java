 ...
 */
@WebServlet("/Gallery/gallery_modify.do")
public class GalleryModifyServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher dispater = 
				request.getRequestDispatcher("Gallery/gallery_modify.jsp");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		GalleryDAO dao = GalleryDAO.getInstance();
		int row = dao.galleryUpdate(vo);
		
		request.setAttribute("page", page);
		request.setAttribute("row", row);
		
		RequestDispatcher dispater = 
				request.getRequestDispatcher("Gallery/gallery_modify_pro.jsp");
		dispater.forward(request, response);
