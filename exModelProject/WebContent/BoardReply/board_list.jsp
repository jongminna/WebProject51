...
%>
        ...
        <td align="center" height="25"><%=list.get(x).getIdx() %></font></td>
	...
	%>			
				<a class="list" href="board_view.jsp?idx=<%=list.get(x).getIdx() %>"><%=list.get(x).getSubject() %></a>
...
%>		
	...
	<table width="600">
		<tr>
			...
			<a href="board_write.jsp?parent=0&realparent=0&depth=0&indent=0"><img src="./img/write.gif" border="0"></a>
			</td>
		</tr>
	</table>
</body>
