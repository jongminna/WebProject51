...
*/
	...
	BoardReplyVO vo = dao.boardSelect(idx);
...
<script>
	function send(){
		alert("자료를 등록합니다.");
		boardreply.action="board_write_pro.jsp";
		boardreply.submit();
	}
 ...
 <tr>
   ...
   <td width="80%" valign="top">&nbsp;<br>
     ...
     <form name="boardreply" method="post">
		<input type="hidden" name="parent" value="<%= vo.getParent() %>">
		<input type="hidden" name="realparent" value="<%=idx%>">
	  ...
	  <table border="0">
	   ...
	   <tr>
         ...
         <td><input type="text" size="60" name="subject" readonly value="<%=vo.getSubject()%>"></td>
       </tr>
       <tr>
         <td align="right"><img src="./img/bullet-02.gif"></td>
