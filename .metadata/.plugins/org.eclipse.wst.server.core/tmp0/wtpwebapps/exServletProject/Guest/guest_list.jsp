...
<%@ page import="java.util.*, com.jslhrd.model.guest.*" %>
<%
  ...
  <tr>
    ...
    <table border="0" cellspacing="1" width="100%" align="center">
      ...
      <tr>
		...
		<font size="2" face="고딕">전체 : ${totcount}</b>건 - ${page} Pages</font></td></tr>
 	   <tr bgcolor="e3e9ff">
...
%>
		<tr onMouseOver="style.backgroundColor='#D1EEEE'" onMouseOut="style.backgroundColor=''">
          ...
          <td align="left" height="20"><font face="돋움" size="2" color="#000000"><a class="list" href="guest_view.do?idx=<%=list.get(x).getIdx()%>&page=${page}"><%= list.get(x).getSubject()%></a></td>
...
%>      
     <div align="center">
		...
		<tr>
						...
						<tr>
							<td>
								<select name="query">
									...
									<option value="contrnts" <% if(query.equals("contents")){ %> selected <% } %>>글내용</option>
								</select>
							</td>
			...
			<a href="/Guest/guest_write.do?page=${page}"><img src="./img/write.gif" border="0"></a>
			</td>
		</tr>
	</table>
